...
Version  : 0.9.2
Release  : 95
URL      : https://files.pythonhosted.org/packages/f2/50/a53f35b42a7d14a8f317dbba219a21938163c58ae3d785667abfe8b2f416/pyroute2-0.9.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/f2/50/a53f35b42a7d14a8f317dbba219a21938163c58ae3d785667abfe8b2f416/pyroute2-0.9.2.tar.gz
...
%prep
%setup -q -n pyroute2-0.9.2
cd %{_builddir}/pyroute2-0.9.2
pushd ..
cp -a pyroute2-0.9.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745877742
