...
Version  : 0.6.8
Release  : 65
URL      : https://files.pythonhosted.org/packages/6b/4c/8d2e173f52255a5a9ce14188126f90d9053344fa80cdd5b7667d8aa0802e/pyroute2-0.6.8.tar.gz
Source0  : https://files.pythonhosted.org/packages/6b/4c/8d2e173f52255a5a9ce14188126f90d9053344fa80cdd5b7667d8aa0802e/pyroute2-0.6.8.tar.gz
...
%prep
%setup -q -n pyroute2-0.6.8
cd %{_builddir}/pyroute2-0.6.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647103849
...
cp %{_builddir}/pyroute2-0.6.8/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2-0.6.8/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2/4cc77b90af91e615a64ae04893fdffa7939db84c
