...
Version  : 0.7.5
Release  : 81
URL      : https://files.pythonhosted.org/packages/29/f4/a9f665da53f6c57ac51afe493df60c9466e473f2eca62c80699798b6fc8d/pyroute2-0.7.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/29/f4/a9f665da53f6c57ac51afe493df60c9466e473f2eca62c80699798b6fc8d/pyroute2-0.7.5.tar.gz
...
%prep
%setup -q -n pyroute2-0.7.5
cd %{_builddir}/pyroute2-0.7.5
pushd ..
cp -a pyroute2-0.7.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676251656
