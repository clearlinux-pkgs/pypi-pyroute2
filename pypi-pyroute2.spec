...
Version  : 0.6.9
Release  : 66
URL      : https://files.pythonhosted.org/packages/b2/77/90796ae6e444048251d327b7a5a9d1fd0dea3d9081a4e4d9c79acacdf501/pyroute2-0.6.9.tar.gz
Source0  : https://files.pythonhosted.org/packages/b2/77/90796ae6e444048251d327b7a5a9d1fd0dea3d9081a4e4d9c79acacdf501/pyroute2-0.6.9.tar.gz
...
%prep
%setup -q -n pyroute2-0.6.9
cd %{_builddir}/pyroute2-0.6.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647894200
...
cp %{_builddir}/pyroute2-0.6.9/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2-0.6.9/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2/4cc77b90af91e615a64ae04893fdffa7939db84c
