...
Version  : 0.6.12
Release  : 69
URL      : https://files.pythonhosted.org/packages/8b/95/2606f89de53fec8a85e2737eefc481ccaccdb3d4ba78544fab65ed4c0339/pyroute2-0.6.12.tar.gz
Source0  : https://files.pythonhosted.org/packages/8b/95/2606f89de53fec8a85e2737eefc481ccaccdb3d4ba78544fab65ed4c0339/pyroute2-0.6.12.tar.gz
...
%prep
%setup -q -n pyroute2-0.6.12
cd %{_builddir}/pyroute2-0.6.12
pushd ..
cp -a pyroute2-0.6.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655133590
...
cp %{_builddir}/pyroute2-0.6.12/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2-0.6.12/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2/4cc77b90af91e615a64ae04893fdffa7939db84c
