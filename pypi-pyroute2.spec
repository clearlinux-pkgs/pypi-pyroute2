...
Version  : 0.6.11
Release  : 68
URL      : https://files.pythonhosted.org/packages/ae/b8/cc94c3bcbbc05409e6c7f8953cf1b216438e4fda361a06f5c7a988897c2f/pyroute2-0.6.11.tar.gz
Source0  : https://files.pythonhosted.org/packages/ae/b8/cc94c3bcbbc05409e6c7f8953cf1b216438e4fda361a06f5c7a988897c2f/pyroute2-0.6.11.tar.gz
...
%prep
%setup -q -n pyroute2-0.6.11
cd %{_builddir}/pyroute2-0.6.11
pushd ..
cp -a pyroute2-0.6.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654538486
...
cp %{_builddir}/pyroute2-0.6.11/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2-0.6.11/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2/4cc77b90af91e615a64ae04893fdffa7939db84c
