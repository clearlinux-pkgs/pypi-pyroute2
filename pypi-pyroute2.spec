...
Version  : 0.6.6
Release  : 63
URL      : https://files.pythonhosted.org/packages/6a/65/d2475a01926dbbf55746ec208c37d557b4dcb848635eb4d59b198910b856/pyroute2-0.6.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/6a/65/d2475a01926dbbf55746ec208c37d557b4dcb848635eb4d59b198910b856/pyroute2-0.6.6.tar.gz
...
%prep
%setup -q -n pyroute2-0.6.6
cd %{_builddir}/pyroute2-0.6.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645044340
...
cp %{_builddir}/pyroute2-0.6.6/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2-0.6.6/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2/4cc77b90af91e615a64ae04893fdffa7939db84c
