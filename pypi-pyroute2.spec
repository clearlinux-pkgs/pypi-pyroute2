...
Version  : 0.6.10
Release  : 67
URL      : https://files.pythonhosted.org/packages/53/53/2b0cffa0e105f0b2fbf15ed5ef5589ca08eb33fc9cefc85d278fc1fb5baa/pyroute2-0.6.10.tar.gz
Source0  : https://files.pythonhosted.org/packages/53/53/2b0cffa0e105f0b2fbf15ed5ef5589ca08eb33fc9cefc85d278fc1fb5baa/pyroute2-0.6.10.tar.gz
...
%prep
%setup -q -n pyroute2-0.6.10
cd %{_builddir}/pyroute2-0.6.10
pushd ..
cp -a pyroute2-0.6.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654528660
...
cp %{_builddir}/pyroute2-0.6.10/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2-0.6.10/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2/4cc77b90af91e615a64ae04893fdffa7939db84c
